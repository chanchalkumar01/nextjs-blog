...
export default function About() {
    return <>
        ...
        <div>
            ...
            Engagement:
            Content aims to capture and hold an audiences attention, encouraging interaction through likes,
            shares, comments, or other forms of participation.
            Value Exchange:
            Effective content provides value, whether its educational, emotional, or entertaining, giving the
